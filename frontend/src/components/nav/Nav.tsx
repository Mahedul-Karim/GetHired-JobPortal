      ...
      <ul className="flex flex-col w-full md:w-auto md:flex-row items-center gap-4">
        {NAV_DATA.map((nav) => (
          ...
          >
            <Link
              to={nav.to}
              className={`transition-all flex text-sm sm:text-base rounded-md md:rounded-none items-center justify-center hover:bg-primary md:hover:bg-transparent hover:text-white w-full md:w-auto duration-300 md:hover:text-primary relative p-2 md:before:absolute md:before:bottom-0 md:before:left-0 md:before:h-[2px]  md:before:bg-primary md:before:transition-all md:before:duration-300 md:hover:before:w-full font-medium ${
