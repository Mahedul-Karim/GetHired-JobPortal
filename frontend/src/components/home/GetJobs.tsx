...
const GetJobs = () => {
  ...
  return (
    <section className="bg-[url('/assets/bg-2.jpg')] bg-cover bg-[top_center]">
      <Container
        className="mt-16 grid md:grid-cols-2 gap-4 overflow-x-clip"
        ref={containerRef}
      >
        <div
          className="flex flex-col justify-center gap-3 opacity-0"
          data-pos="left"
        >
          <h4 className="text-primary text-base sm:text-xl font-semibold">
            Get Jobs
          </h4>
          <h2 className="text-dark-0 font-bold text-3xl sm:text-4xl lg:text-5xl leading-[1.2]">
            Get World&apos;s <span className="text-gradient"> 25,000+</span>{" "}
            <br /> Talented People in <br />
            one place
          </h2>
          <p className="text-dark-0 text-sm lg:text-base max-w-[515px] leading-[1.6]">
        ...
        <div className="relative rounded-md z-[1] opacity-0" data-pos="right">
          ...
          <img
            src="/assets/get-job.png"
            alt=""
            className="object-cover mx-auto max-h-[380px] md:max-h-[450px]"
          />
        </div>
      </Container>
    </section>
